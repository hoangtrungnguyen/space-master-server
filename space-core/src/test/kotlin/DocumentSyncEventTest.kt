...
class DocumentSyncEventTest {
    ...
    fun `should deserialize DocumentSyncEventValue from JSON string`() {
        ...
        {
            "sync_op": "EDIT_DOC",
            "doc_id": "a81bc81b-dead-4e5d-abff-90865d1e13b1",
        ...
        assertEquals("a81bc81b-dead-4e5d-abff-90865d1e13b1", event.docId)
        ...
        assertEquals(ElementOp.EDIT_ELEMENT, payload.elementOp)

        val element = payload.element
        assertEquals(Uuid.parse("c3a4e5f6-1234-5678-90ab-cdef12345678"), element.uuid)
        assertEquals(Uuid.parse("d4e5f6a7-2345-6789-01bc-def012345678"), element.parentUuid)
