...
class CityService(private val connection: Connection) {
    companion object {
        private const val CREATE_TABLE_CITIES =
            "CREATE TABLE IF NOT EXISTS PUBLIC.CITIES (ID SERIAL PRIMARY KEY, NAME VARCHAR(255), POPULATION INT);"
    ...
    init {
        connection.createStatement().use { statement ->
            ...
            statement.executeUpdate("INSERT INTO CITIES (NAME, POPULATION) VALUES ('New York', 8000000);")
            statement.executeUpdate("INSERT INTO CITIES (NAME, POPULATION) VALUES ('Los Angeles', 4000000);")
            statement.executeUpdate("INSERT INTO CITIES (NAME, POPULATION) VALUES ('Chicago', 3000000);")
        }
